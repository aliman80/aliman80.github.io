...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;width: 100%;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="https://openreview.net/pdf/a17eaeff6f27eb0ee7e9f5787f8fb7bf7b3fee07.pdf">WASTEBENCH: A ComprehensiveBenchmark for Evaluating VLLMs in Cluttered Environments</a></div>
    ...
    <div class="links">
      ...
      <a href="HTTPS://github.com/aliman80/wastebench" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Code</a>
      <strong><i style="color:#e74d3c"></i></strong>
    </div>
  </div>
</div>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;width: 100%;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="links">
      ...
      <a href="https://github.com/techmn/cosnet" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Code</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;width: 100%;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="links">
      ...
      <a href="https://github.com/aliman80/Underwater-Object-Detection-via-Channel-Stablization" class="btn btn-sm z-depth-0" target="_blank" style="font-size:12px;">Code</a>
